...
// New validation functions for expiry month and year
...
function processPayment() {
    ...
    // Additional validation for expiry month and year
    let monthValue = parseInt(expiryMonth);
    let yearValue = parseInt(expiryYear);
