document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add this with your other cart JavaScript code
document.getElementById('checkout').addEventListener('click', function() {
    // Get the total price from the cart display
    const totalPrice = document.querySelector('.total-price').textContent;
    
    // Store it for the payment page
    ...
    function proceedToCheckout() {
        ...
        window.location.href ="file:///C:/Users/MOHANAD/OneDrive/Desktop/Web/salma/payment.html";
    }
